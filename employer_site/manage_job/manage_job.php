...
<style>
    :root { --primary-blue: #0c4a86; --bg-gray: #f4f7f6; --delete-red: #dc3545; }
    ...
    .manage-header { background: white; padding: 20px; border-radius: 10px; margin-bottom: 30px; text-align: center; border: 1px solid #ddd; }
    ...
    /* STATUS BADGE STYLES */
    .status-badge { display: inline-flex; align-items: center; gap: 6px; padding: 5px 15px; border-radius: 6px; font-size: 13px; font-weight: bold; margin-bottom: 10px; }
    ...
    .check-icon { background-color: #22c55e; color: white; border-radius: 4px; padding: 0 4px; font-size: 11px; }

    /* SKILL TAGS */
    .skills-flex { display: flex; flex-wrap: wrap; gap: 12px; margin-top: 20px; }
    .skill-box { background-color: var(--primary-blue); color: white; padding: 8px 22px; border-radius: 6px; font-size: 14px; font-weight: 500; }

    .job-title { font-size: 22px; font-weight: bold; margin: 0; display: flex; align-items: center; gap: 10px; }
    .type-label { background: #d1e3f8; color: #0c4a86; padding: 2px 10px; border-radius: 4px; font-size: 12px; }
    
    .action-btns { position: absolute; top: 30px; right: 30px; display: flex; gap: 20px; }
    .action-btns img { width: 40px; cursor: pointer; transition: 0.2s; }
    ...
    .modal-content { 
        background: white; padding: 40px; border-radius: 20px; width: 450px; text-align: center; 
        box-shadow: 0 10px 30px rgba(0,0,0,0.2); 
    }
    .modal-content img { width: 80px; margin-bottom: 20px; }
    .modal-content h2 { color: var(--primary-blue); margin-bottom: 10px; font-size: 24px; }
    .modal-content p { color: #666; margin-bottom: 30px; }
    .modal-btns { display: flex; justify-content: space-between; gap: 20px; }
    .btn-modal { flex: 1; padding: 12px; border-radius: 8px; border: none; font-weight: bold; cursor: pointer; font-size: 16px; }
    .btn-cancel { background: #2e3b8e; color: white; }
    .btn-delete { background: #888; color: white; }
</style>

<div class="manage-container">
    <div class="manage-header"><h1>Manage Job</h1></div>
