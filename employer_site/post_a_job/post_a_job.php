...
<style>
.form-container { background-color: white; width: 100%; max-width: 600px; margin: 80px auto; padding: 40px 50px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
...
.btn-primary { background-color: #0c4a86; border: none; color: white; font-size: 16px; font-weight: 600; padding: 15px 0; border-radius: 5px; cursor: pointer; transition: 0.3s; }
...
<div class="form-container">
  ...
  <form id="post-job-form" onsubmit="submitJob(event)">
    ...
    <div class="form-group"><label>Skills</label><textarea name="skills" placeholder="PHP, JavaScript, HTML (Use commas to separate)"></textarea></div>
